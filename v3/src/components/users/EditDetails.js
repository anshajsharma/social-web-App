...
const styles = {
 ...
 class EditDetails extends Component {
     ...
     componentDidMount(){      // Loads data from server before rendering....
                ...
                <Dialog open={this.state.open} onClose={this.handleClose} fullWidth maxWidth='sm'>
                    ...
                    <DialogContent>
                        <form>
                          ...
                          <TextField name="website" type="text" label="Website" placeholder="www.example.com"
                                       className={classes.textField} value={this.state.website} onChange={this.handleChange} fullWidth />
                          <TextField name="location" type="text" label="Location" placeholder="London,UK"
